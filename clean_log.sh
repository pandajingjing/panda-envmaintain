...
_sYamlParam="sDeployServer=$sDeployServer sDeployUser=$sDeployUser sDeleteRootDir=$sLogInstallRootDir/app/laravel/storage-release sDeletePattern=$sCleanPattern"
